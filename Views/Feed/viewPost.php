<div class="post">
	...
	<button type="submit"><svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="gratipay" class="like" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
	...
	</path></svg><p class="nLikes"><?php echo $v['likes']." likes";?></p></button></form>
